...
<head>
    ...
    <title>Blaster ORG</title>
    
    <link rel="stylesheet" href="https://blaster.org.uk/css/blaster/index.css">
        ...
        <div class="container py-4">
            <header class="pb-3 mb-4 border-bottom">
                <a href="https://blaster.org.uk/" class="d-flex align-items-center text-dark text-decoration-none">
                    <img class="mb-2" src="https://blasterphp.blaster.org.uk/public/storge/logo.png" alt="" width="100" height="100">
                    <span class="fs-4 text-success"><h1>BLASTER ORGANIZATION</h1></span>
                </a>
            </header>

            <div class="p-5 mb-4 rounded-3">
                <div class="container-fluid py-5 hover-2">
                    <div class="m-4 roundedd-3">
                    <h1 class="display-5 fw-bold text-uppercase blaster-text2">dev server</h1>
                    <p class="col-md-8 fs-4 text-success">This repository cloned from the organization account on github.</p>
                    <a href="https://github.com/umarelmahedi/deploy" target="_blank"><button class="btn btn-success btn-lg" type="button">Github</button></a>
                    </div>
                </div>
            </div>
